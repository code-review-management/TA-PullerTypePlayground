 ...
 */
const MergeSuccessPopup: React.FC<MergeAlertPopupProps> = ({ isOpen, isDark, targetBranch, featureBranch, children }) => {
    ...
    return (
        <div className={styles.overlay}>
            <div className={popupClass}>
                ...
                <p className={styles.message}>{featureBranch} is up to date with {targetBranch}.</p>
